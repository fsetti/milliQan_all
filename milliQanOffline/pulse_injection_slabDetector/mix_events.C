...
void prepareOutBranchesMix(){
    ...
    b_chan_muDist = outTree->Branch("chan_muDist",&chan_muDist,"chan_muDist[8]/F");
    b_chan_trueNPE = outTree->Branch("chan_trueNPE",&chan_trueNPE,"chan_trueNPE[8]/I");
