...
void SlimTree::Init(TTree *t){
    ...
    if(t == NULL){
        ...
        b_chan_nPE               = this->t->Branch("chan_nPE", chan_nPE, "chan_nPE[890]/I");
        b_chan_fracMuon          = this->t->Branch("chan_fracMuon", chan_fracMuon, "chan_fracMuon[890]/F");
        b_chan_fracElScint       = this->t->Branch("chan_fracElScint", chan_fracElScint, "chan_fracElScint[890]/F");
        b_chan_fracElAl          = this->t->Branch("chan_fracElAl", chan_fracElAl, "chan_fracElAl[890]/F");
        b_chan_fracElRock        = this->t->Branch("chan_fracElRock", chan_fracElRock, "chan_fracElRock[890]/F");
        b_chan_fracElPb          = this->t->Branch("chan_fracElPb", chan_fracElPb, "chan_fracElPb[890]/F");
        b_chan_fracOther         = this->t->Branch("chan_fracOther", chan_fracOther, "chan_fracOther[890]/F");
        b_chan_firstTime         = this->t->Branch("chan_firstTime", chan_firstTime, "chan_firstTime[890]/F");
        b_chan_meanTime          = this->t->Branch("chan_meanTime", chan_meanTime, "chan_meanTime[890]/F");
        b_chan_timeCalib         = this->t->Branch("chan_timeCalib", chan_timeCalib, "chan_timeCalib[890]/F");
        b_chan_muDist            = this->t->Branch("chan_muDist", chan_muDist, "chan_muDist[890]/F");
        b_chan_muTime            = this->t->Branch("chan_muTime", chan_muTime, "chan_muTime[890]/F");
        b_chan_firstPEPathLength = this->t->Branch("chan_firstPEPathLength", chan_firstPEPathLength, "chan_firstPEPathLength[890]/F");
        b_chan_maxSourceType     = this->t->Branch("chan_maxSourceType", chan_maxSourceType, "chan_maxSourceType[890]/I");
        b_chan_maxSourceE0       = this->t->Branch("chan_maxSourceE0", chan_maxSourceE0, "chan_maxSourceE0[890]/F");
        b_chan_maxSourceNPE      = this->t->Branch("chan_maxSourceNPE", chan_maxSourceNPE, "chan_maxSourceNPE[890]/I");
        b_chan_type              = this->t->Branch("chan_type", chan_type, "chan_type[890]/I");
        ...
        b_mcTruth_twoSlab       = this->t->Branch("mcTruth_twoSlab", &mcTruth_twoSlab, "mcTruth_twoSlab/O");
        ...
        this->t->SetBranchAddress("mcTruth_twoSlab", &mcTruth_twoSlab, &b_mcTruth_twoSlab);
